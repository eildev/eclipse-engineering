            ...
            <div class="card">
                <div class="card-body">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4>Management Team </h4><br>
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item active">
                                    <a href="{{ route('managing.team.view') }}"
                                        class=" btn btn-sm btn-primary text-light">View Management Team</a>
                                </li>
                            </ol>
                        </div>
                    </div>
                    <hr>
                    <form action="{{ url('managing/team/store') }}" method="post" id="addajax"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control @error('name') is-invalid  @enderror" name="name"
                                    type="text" placeholder="Enter Management Team Member Name " id="name">
                                @error('name')
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control @error('designation') is-invalid  @enderror" name="designation"
                                    type="text" placeholder="Enter Designation " id="designation">
                                @error('designation')
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control " name="instagram" type="url"
                                    placeholder="https://www.instagram.com/" id="example-email-input">
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control " name="linkedin" type="url"
                                    placeholder="https://www.linkedin.com/ " id="example-email-input">
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control " name="twitter" type="url"
                                    placeholder="https://www.twitter.com/" id="example-email-input">
                            </div>
                        </div>
                        <div class="row mb-3">
