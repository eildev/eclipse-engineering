                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('store.slider') }}" method="post" id ="myForm" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10 form-group">
                                <input class="form-control" name="short_title" type="text"
                                    placeholder="Enter Short Title" id="example-email-input" required>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="example-email-input" class="col-sm-2 col-form-label">Sub title</label>
                            <div class="col-sm-10 form-group">
                                <input class="form-control" name="sub_title" type="text" placeholder="Enter Sub Title"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10 form-group">
                                <input class="form-control" type="url" placeholder="Enter Slider link"
                                    name="slider_links" id="example-email-input" required>
