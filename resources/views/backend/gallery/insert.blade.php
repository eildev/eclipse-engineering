                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item active">
                                    <a href="{{ route('gallery.view') }}" class=" btn btn-sm btn-primary text-light fs-4">
                                        +</a>
                                </li>
                            </ol>
                        </div>
                    ...
                    <form action="{{ route('store.gallery') }}" method="post" id ="myForm" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10 form-group">
                                <input class="form-control" name="gallery_title" type="text"
                                    placeholder="Enter Gallery Title" id="example-email-input">
