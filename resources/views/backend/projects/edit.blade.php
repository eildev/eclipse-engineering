            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('update.projects', $project->id) }}" method="post" id ="myForm"
                        ...
                        <div class="row mb-3">
                            <label for="example-email-input" class="col-sm-2 col-form-label">Projects Sub Title</label>
                            <div class="col-sm-10 form-group">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <img id="showImage" class="rounded avatar-lg "
                                    src="{{ $project->image ? asset('uploads/projects/' . $project->image) : asset('dummy-img/no-img.jpg') }}"
                                    alt="projects Image">
                            </div>
