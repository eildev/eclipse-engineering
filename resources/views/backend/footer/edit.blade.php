                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('update.footer', $footer->id) }}" method="post">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea id="" class="form-control" name="fullAddress" placeholder="Enter  Your Address" cols="60"
                                    rows="3" Required>{{ $footer->fullAddress }}</textarea>
                            </div>
                        </div>
                        <!-- end row -->
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" value="{{ $footer->email }}" name="email" type="email"
                                    placeholder="Enter Your Email" id="example-email-input" Required>
                            </div>
                        </div>
                        <!-- end row -->
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" name="phone" value="{{ $footer->phone }}" type="text"
                                    placeholder="Enter Your Number" value="+880" id="example-number-input" Required>
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea id="" class="form-control" name="description" placeholder="Enter Short Description" cols="60"
                                    rows="3" Required>{{ $footer->description ?? '' }}</textarea>
                            </div>
                        </div>
                        <div class="row mb-3">
