        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item active">
                                    <a href="{{ route('service.details.view') }}"
                    ...
                    <form action="{{ route('update.service.details', $servicesDetails->id) }}" method="post"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <select class="form-select @error('services_title') is-invalid  @enderror"
                                    name="services_title" aria-label="Default select example">
                                    <option selected="" value=""> Select Service Title</option>
                                    @foreach ($services as $service)
                                        <option value="{{ $service->id }}"
                                            {{ $service->id == $servicesDetails->services_id ? 'selected' : '' }}>
                                            {{ $service->services_title }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control @error('services_details_title') is-invalid  @enderror"
                                    name="services_details_title" type="text"
                                    value="{{ $servicesDetails->services_details_title }}"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea id="summernote" class="form-control @error('services_details_description') is-invalid  @enderror"
                                    name="services_details_description" style="resize: none; height: 150px;">{!! $servicesDetails->services_details_description !!}</textarea>
                        ...
                        <div class="row mb-3">
                            <label for="example-input" class="col-sm-2 col-form-label">Service Details Icon Name</label>
                            <div class="col-sm-10">
                                <input class="form-control @error('services_details_icon_name') is-invalid  @enderror"
                                    name="services_details_icon_name" type="text"
                                    placeholder="Enter  Service Details Title" id="example-input"
                                    value="{{ $servicesDetails->services_details_icon_name }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <img id="showImage" class="rounded avatar-lg "
                                    src="{{ asset('uploads/services_image/' . $servicesDetails->services_details_icon) }}"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input name="services_details_image" value="{{ $servicesDetails->services_details_image }}"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <img id="showImage2" class="rounded avatar-lg "
                                    src="{{ asset('uploads/services_image/' . $servicesDetails->services_details_image) }}"
                                    alt="Service Details Image">
