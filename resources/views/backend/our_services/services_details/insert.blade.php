                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control @error('services_details_title') is-invalid  @enderror"
                                    name="services_details_title" type="text" placeholder="Enter  Service Details Title"
                                    id="example-input">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea id="summernote" class="form-control @error('services_details_description') is-invalid  @enderror"
                                    name="services_details_description" style="resize: none; height: 150px;"> </textarea>
