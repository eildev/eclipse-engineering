 ...
 <section class="tj-hero-section" data-bg-image="{{ asset('frontend') }}/assets/images/banner/hero-bg.jpg">
     <div class="container">
         <div class="row">
             <div class="col-lg-12 col-md-8">
                 <div class="hero-content-ara">
                     <div class="tj-sec-heading">
                         <span class="sub-title">Solar Energy</span>
                         <h1 class="sec-title">
                             Energize Society Reliable
                             <span>Energy</span>
                         </h1>
                         <div class="desc">
                             <p>
                         ...
                         <div class="tj-hero-button">
                             <a class="tj-primary-btn2 btn" href="contact.html">
     ...
     <div class="hero-wrapper">
         <div class="hero-feature-image">
             <img src="{{ asset('frontend') }}/assets/images/banner/feature-bg.jpg" alt="Image" />
         </div>
